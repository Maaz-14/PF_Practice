#include <stdio.h>
 ...
 int main() {
    ...
    // while(1) while (-1) while (2...) or any number EXCEPT 0 would always be true and will run infinite times until Break statement!!!!..
    // while (0) will not run as it is considered FALSE! RUN while (0) to implement this 
    while (-1) {
